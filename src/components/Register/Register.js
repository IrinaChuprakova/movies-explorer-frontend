...
function Register(props){
    ...
    return(
        ...
        <input className="register__input" type="text" placeholder="Ваше имя" name="name" value={values.name || ""} onChange={handleChange} minLength="2" maxLength="30" required></input>
        ...
        <input className="register__input" type="password" placeholder="Придумайте пароль" name="password" value={values.password || ""} onChange={handleChange} required></input>
